...
export function PaypalIcon({ className, ...props }: SVGProps<SVGSVGElement>) {
    return (
        <svg
            ...
            {...props}
        >
            <path d="M20.067 8.478c.492 3.11-.09 5.448-1.734 7.012-1.916 1.816-4.933 2.278-7.52 2.278H9.12l-.96 6.088h-3.12L7.076 2.47h6.55c2.637 0 5.193.54 6.441 2.008ZM9.92 12.53h1.84c2.337 0 4.12-.96 4.648-3.72.19-1.08.09-1.95-.3-2.61-.42-.69-1.17-1.05-2.22-1.05H10.8l-.88 5.58Z" />
        </svg>
    );
}
