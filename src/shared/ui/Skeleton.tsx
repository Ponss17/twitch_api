            ...
            <div className="mb-3 flex flex-col rounded-xl border border-border-subtle bg-bg-card">
                <header className="flex flex-wrap items-center justify-between gap-3 border-b border-border-subtle px-5 py-3.5">
                    ...
                    <div className="flex gap-3">
                        <Skeleton className="h-8 w-32 rounded-lg bg-transparent border border-border-subtle" />
                        <Skeleton className="h-8 w-32 rounded-lg bg-transparent border border-border-subtle" />
                    </div>
                </header>
                <div className="p-5">
                    <Skeleton className="h-[400px] w-full rounded-lg bg-bg-card border border-border-subtle" />
                </div>
            </div>
        </div>
    );
