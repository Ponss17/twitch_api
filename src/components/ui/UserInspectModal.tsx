...
export function UserInspectModal({ user, onClose, showLogs = true }: UserInspectModalProps) {
    ...
    return createPortal(
        <div
            className="fixed inset-0 z-[2000] overflow-y-auto bg-black/70 backdrop-blur-[5px]"
            onClick={onClose}
        >
            <div className="flex min-h-full items-center justify-center p-4 py-10 sm:p-6 sm:py-12">
                <div
                    role="dialog"
                    aria-modal="true"
