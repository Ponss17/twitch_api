...
export const docsCopyBtn =
    'absolute top-1/2 right-3 -translate-y-1/2 flex cursor-pointer items-center justify-center gap-1.5 rounded-md border border-primary bg-primary px-3 py-1.5 text-[0.8rem] font-medium text-white shadow-[0_0_15px_rgba(145,70,255,0.2)] transition hover:brightness-110';
