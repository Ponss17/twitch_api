...
export const docsPage = 'min-h-screen overflow-x-hidden bg-bg-main font-sans text-text-main antialiased';

export const docsSearchWrap = 'relative mb-3 flex shrink-0 items-center px-1';

export const docsSearchIcon =
    'pointer-events-none absolute left-3 top-1/2 z-10 -translate-y-1/2 text-[0.85rem] text-text-muted';
...
export const docsContent =
    'mx-auto w-full max-w-[1600px] flex-1 px-4 py-6 md:px-6 md:py-8 [&_a]:font-semibold [&_a]:text-primary [&_a]:no-underline [&_a]:transition hover:[&_a]:text-primary-hover [&_code]:rounded [&_code]:border [&_code]:border-border-subtle [&_code]:bg-text-main/10 dark:bg-text-main/[0.08] [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:font-mono [&_code]:text-[0.85em] [&_code]:text-text-main [&_h2]:relative [&_h2]:mb-6 [&_h2]:flex [&_h2]:items-center [&_h2]:gap-3 [&_h2]:border-b [&_h2]:border-border-strong [&_h2]:pb-3 [&_h2]:text-[1.35rem] [&_h2]:font-bold [&_h2]:tracking-tight [&_h2]:text-text-main md:[&_h2]:text-[1.5rem] [&_h2_i]:text-primary [&_h3]:my-5 [&_h3]:text-[1rem] [&_h3]:font-bold [&_h3]:text-text-main [&_p]:mb-4 [&_p]:text-[0.9375rem] [&_p]:leading-relaxed [&_p]:text-text-muted';

export const docSection = `mb-16 min-h-[200px] scroll-mt-28 ${fadeIn}`;

export const docsMainTitle =
    'mb-4 text-[2rem] font-extrabold leading-tight tracking-tight text-text-main md:text-[2.4rem]';

export const docsAccent = 'text-primary';

export const docsLead =
    'mb-8 max-w-[720px] text-[1.05rem] leading-relaxed text-text-muted md:text-[1.125rem]';

export const docsIntroGrid =
    'mt-6 grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-4';

export const docsStepSeparator = 'text-[0.75rem] text-text-muted opacity-60';

const infoCardBase =
    'mb-6 flex gap-4 rounded-xl border border-border-strong bg-bg-card p-4 transition-[border-color] duration-200 [&_p]:mb-0 [&_p]:text-[0.875rem] [&_p]:leading-relaxed [&_p]:text-text-muted';
...
export const docsUrl = 'break-all text-[0.875rem] text-text-main';

export const docsUrlParam = 'font-bold text-primary';

export const docsParamsTable =
    `${card} my-6 w-full overflow-hidden border-separate border-spacing-0 p-0 [&_td]:border-b [&_td]:border-border-strong [&_td]:px-5 [&_td]:py-4 [&_th]:bg-text-main/5 [&_th]:px-5 [&_th]:py-4 [&_th]:text-left [&_th]:text-[0.8125rem] [&_th]:font-bold [&_th]:tracking-wide [&_th]:text-text-main [&_th]:uppercase [&_tr:last-child_td]:border-b-0 [&_tr:hover_td]:bg-text-main/5`;

export const docsCodeBlock =
    `${card} my-6 border-l-4 border-l-primary py-3 pr-[100px] [&_code]:block [&_code]:!border-none [&_code]:!bg-transparent [&_code]:!p-0 [&_code]:font-[Consolas,monospace] [&_code]:text-[0.8125rem] [&_code]:leading-relaxed [&_code]:text-text-main [&_code]:whitespace-pre-wrap`;
...
export const docsStepCard =
    `${card} relative overflow-hidden p-4 hover:border-primary/30 [&_h3]:mb-2 [&_h3]:text-[1rem] [&_h3]:font-bold [&_h3]:text-text-main [&_p]:mb-0 [&_p]:text-[0.8125rem]`;
...
export const docsTabContainer =
    'my-6 overflow-hidden rounded-xl border border-border-strong border-l-4 border-l-primary bg-bg-card';

export const docsTabHeader =
    'flex flex-wrap items-center justify-between gap-3 border-b border-border-strong px-3 py-2.5 max-[600px]:flex-col max-[600px]:items-stretch';
...
export const docsTabBtn = (active: boolean) =>
    `cursor-pointer rounded-lg border px-3 py-1.5 text-[0.8125rem] font-semibold transition max-[600px]:flex-1 ${
        active
            ? 'border-primary/40 bg-primary/15 text-text-main'
            : 'border-border-strong bg-text-main/5 text-text-muted hover:border-border-strong hover:text-text-main'
    }`;
...
export const docsTabCodeArea =
    'relative px-4 py-3.5 pr-[108px] [&_code]:block [&_code]:font-[Consolas,monospace] [&_code]:text-[0.8125rem] [&_code]:leading-relaxed [&_code]:text-text-main [&_code]:whitespace-pre-wrap [&_code]:break-all';
...
export const docsBadgeNeutral =
    'rounded-md border border-border-strong bg-text-main/5 dark:bg-white/5 px-2 py-1 text-[0.7rem] font-bold tracking-wide text-text-muted';
