...
export const es = {
    ...
    analytics: {
        ...
        todayChart: {
            title: 'Actividad Hoy (Por Hora)',
            info: 'Distribución horaria de peticiones.',
            success: 'Éxitos',
            errors: 'Errores',
            successRate: 'Tasa de Éxito',
    ...
    modals: {
        ...
        login: {
            ...
            accept: 'Aceptar',
            desc1: 'Estás a punto de iniciar sesión con Twitch.',
            desc1Bold: 'Twitch',
            desc1End: '.',
            desc2: 'Al hacerlo, aceptas nuestros:',
            point1: 'Términos de Servicio',
            point2: 'Política de Privacidad',
            point3: 'Uso de Cookies',
            disclaimer: 'Puedes revocar el acceso en cualquier momento.',
    ...
    minigames: {
        ...
        roulette: {
            ...
            infoTooltip: 'Selecciona quién puede participar',
    ...
    stalker: {
        ...
        btnStart: 'Iniciar',
        btnReload: 'Limpiar',
        tooltip: 'Monitor de palabras clave',
        table: {
            user: 'Usuario',
            message: 'Mensaje',
            time: 'Hora',
