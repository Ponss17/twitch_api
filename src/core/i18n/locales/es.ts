...
export const es = {
    ...
    reports: {
        ...
        browseByMonth: 'Por mes',
        months: 'Meses',
        metaCategory: 'Uso de comandos',
        latestBadge: 'Último',
        entryTitle: 'Tu mes en {month}',
        ...
        intro: 'Cuántas veces se usaron tus comandos de LosPerris en el chat durante este mes.',
        note: 'No incluye viewers del stream ni estadísticas de Twitch: solo el uso de la API.',
        story: 'En total hubo {uses} usos ({rate}% OK). Lo más usado fue {command}; quien más los disparó fue {viewer}.',
        ...
        emptyBody:
            'Cuando pases un mes usando comandos en el chat, aquí verás el resumen y te avisamos en la campanita.',
        emptyCtaAnalytics: 'Ver Analíticas (en vivo)',
        emptyCtaCommands: 'Configurar un comando',
        monthMeta: '{count} usos · {rate}% OK',
        monthMetaOne: '1 uso · {rate}% OK',
        commands: 'Qué se usó',
        commandsHint: 'Comando y cuántas veces se ejecutó',
        listCommand: 'Comando',
        listUses: 'Usos',
        listLatency: 'Media',
        listViewer: 'Usuario',
        noCommands: 'Sin comandos este mes',
        commandUses: '{count} usos',
        commandUsesOne: '1 uso',
        commandLatency: '{ms} ms de media',
        topViewers: 'Quién más los usó',
        topViewersHint: 'Personas del chat que dispararon comandos',
        viewerUses: '{count} usos',
        viewerUsesOne: '1 uso',
        noViewers: 'Nadie del chat usó comandos este mes.',
        lowActivity:
            'Hubo poca actividad este mes ({count} usos). Es normal si acabas de configurar los comandos.',
        lowActivityOne:
            'Solo hubo 1 uso este mes. Es normal si acabas de configurar los comandos.',
        downloadHtml: 'Descargar HTML',
        downloadCsv: 'Descargar CSV',
        loadError: 'No se pudieron cargar los reportes.',
        vsPrevious: 'Respecto a {month}: {delta} usos',
        vsPreviousUp: 'Respecto a {month}: +{delta} usos',
        vsPreviousDown: 'Respecto a {month}: {delta} usos',
        notificationTitle: 'Listo: resumen de {month}',
        notificationBody: 'Ya puedes ver cuánto se usaron tus comandos el mes pasado.',
        openReport: 'Ver resumen',
        kpis: {
    ...
    analytics: {
        ...
        todayChart: {
            ...
            noData: 'Aún no hay actividad hoy',
            noDataSub: 'Cuando uses un comando en el chat, verás el desglose aquí.'
        },
        latencyChart: {
            title: 'Rendimiento y Latencia',
            info: 'Uso y tiempo de respuesta por comando.',
            noData: 'Sin mediciones todavía',
            noDataSub: 'La latencia aparece cuando tus comandos empiezan a usarse.',
            latency: 'Latencia Media',
            colCommand: 'Comando',
            colRequests: 'Cantidad',
            colLatency: 'Latencia'
        },
        areaChart: {
            title7d: 'Tráfico y Errores (7 días)',
            title30d: 'Tráfico y Errores (30 días)',
            info7d: 'Historial de los últimos 7 días. El día actual se actualiza en vivo.',
            info30d: 'Historial de los últimos 30 días. El día actual se actualiza en vivo.',
            requests: 'Peticiones',
            errors: 'Errores',
            noData7d: 'Sin tráfico esta semana',
            noData30d: 'Sin tráfico en 30 días',
            noDataSub7d: 'Cuando haya peticiones, verás la curva de los últimos 7 días.',
            noDataSub30d: 'Cuando haya peticiones, verás la curva de los últimos 30 días.'
        },
        leaderboard: {
            title: 'Top Usuarios',
            infoToday: 'Usuarios más activos hoy.',
            info7d: 'Usuarios más activos en 7 días.',
            info30d: 'Usuarios más activos en 30 días.',
            noData: 'Nadie ha interactuado aún',
            noDataSub: 'Los viewers aparecerán aquí al usar tus comandos.',
            rankingToday: 'Top Hoy',
            ranking7d: 'Top 7 Días',
            ranking30d: 'Top 30 Días',
    ...
    header: {
        subtitles: {
            ...
            reports: 'Cuántas veces se usaron tus comandos este mes',
