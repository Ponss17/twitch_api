...
export const en: Translations = {
    ...
    modals: {
        ...
        login: {
            ...
            accept: 'Accept',
            desc1: 'You are about to log in with Twitch.',
            desc1Bold: 'Twitch',
            desc1End: '.',
            desc2: 'By doing so, you agree to our:',
            point1: 'Terms of Service',
            point2: 'Privacy Policy',
            point3: 'Cookie Policy',
    ...
    clips: {
        ...
        viewClip: 'Ver Clip',
        playClip: (title) => `Reproducir clip: ${title}`,
