...
export const en: Translations = {
    ...
    reports: {
        ...
        months: 'Months',
        metaCategory: 'Command usage',
        latestBadge: 'Latest',
        entryTitle: 'Your month in {month}',
        ...
        intro: 'How many times your LosPerris chat commands were used this month.',
        note: 'This is not Twitch channel analytics — only API / command usage.',
        story: 'There were {uses} uses ({rate}% OK). Most used: {command}. Top chatter: {viewer}.',
        storyTitle: 'In short',
        ...
        emptyBody:
            'After a month of chat command usage, the summary shows up here and we ping the bell.',
        emptyCtaAnalytics: 'Open live Analytics',
        emptyCtaCommands: 'Set up a command',
        monthMeta: '{count} uses · {rate}% OK',
        monthMetaOne: '1 use · {rate}% OK',
        commands: 'What was used',
        commandsHint: 'Command and how many times it ran',
        listCommand: 'Command',
        listUses: 'Uses',
        listLatency: 'Avg',
        listViewer: 'User',
        noCommands: 'No commands this month',
        commandUses: '{count} uses',
        commandUsesOne: '1 use',
        commandLatency: '{ms} ms avg',
        topViewers: 'Who used them most',
        topViewersHint: 'Chat users who triggered commands',
        viewerUses: '{count} uses',
        viewerUsesOne: '1 use',
        noViewers: 'No one in chat used commands this month.',
        lowActivity:
            'Low activity this month ({count} uses). Normal if you just set up commands.',
        lowActivityOne:
            'Only 1 use this month. Normal if you just set up commands.',
        downloadHtml: 'Download HTML',
        downloadCsv: 'Download CSV',
        loadError: 'Could not load reports.',
        vsPrevious: 'Vs {month}: {delta} uses',
        vsPreviousUp: 'Vs {month}: +{delta} uses',
        vsPreviousDown: 'Vs {month}: {delta} uses',
        notificationTitle: 'Ready: {month} summary',
        notificationBody: 'You can see how much your commands were used last month.',
        openReport: 'View summary',
        kpis: {
            requests: 'Total uses',
    ...
    header: {
        subtitles: {
            ...
            reports: 'How often your commands were used this month',
