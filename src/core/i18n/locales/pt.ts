...
export const pt: Translations = {
    ...
    reports: {
        ...
        browseByMonth: 'Por mês',
        months: 'Meses',
        metaCategory: 'Uso de comandos',
        latestBadge: 'Mais recente',
        entryTitle: 'Seu mês em {month}',
        ...
        intro: 'Quantas vezes seus comandos do LosPerris foram usados no chat neste mês.',
        note: 'Não inclui analytics do canal da Twitch — só uso da API / comandos.',
        story: 'No total houve {uses} usos ({rate}% OK). O mais usado foi {command}; quem mais disparou foi {viewer}.',
        ...
        emptyBody:
            'Depois de um mês usando comandos no chat, o resumo aparece aqui e avisamos no sino.',
        emptyCtaAnalytics: 'Ver Análises (ao vivo)',
        emptyCtaCommands: 'Configurar um comando',
        monthMeta: '{count} usos · {rate}% OK',
        monthMetaOne: '1 uso · {rate}% OK',
        commands: 'O que foi usado',
        commandsHint: 'Comando e quantas vezes rodou',
        listCommand: 'Comando',
        listUses: 'Usos',
        listLatency: 'Média',
        listViewer: 'Usuário',
        noCommands: 'Sem comandos neste mês',
        commandUses: '{count} usos',
        commandUsesOne: '1 uso',
        commandLatency: '{ms} ms em média',
        topViewers: 'Quem mais usou',
        topViewersHint: 'Pessoas do chat que dispararam comandos',
        viewerUses: '{count} usos',
        viewerUsesOne: '1 uso',
        noViewers: 'Ninguém do chat usou comandos neste mês.',
        lowActivity:
            'Pouca atividade neste mês ({count} usos). Normal se você acabou de configurar.',
        lowActivityOne:
            'Só houve 1 uso neste mês. Normal se você acabou de configurar.',
        downloadHtml: 'Baixar HTML',
        downloadCsv: 'Baixar CSV',
        loadError: 'Não foi possível carregar os relatórios.',
        vsPrevious: 'Vs {month}: {delta} usos',
        vsPreviousUp: 'Vs {month}: +{delta} usos',
        vsPreviousDown: 'Vs {month}: {delta} usos',
        notificationTitle: 'Pronto: resumo de {month}',
        notificationBody: 'Já dá para ver quanto seus comandos foram usados no mês passado.',
        openReport: 'Ver resumo',
        kpis: {
    ...
    header: {
        subtitles: {
            ...
            reports: 'Quantas vezes seus comandos foram usados neste mês',
