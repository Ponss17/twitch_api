...
export function AnalyticsTodayBarChart({
    ...
    return (
        <div className="col-span-1 lg:col-span-2 flex flex-col rounded-xl border border-white/[0.08] bg-bg-card p-6 transition-colors duration-200 hover:border-primary/50 h-[460px]">
