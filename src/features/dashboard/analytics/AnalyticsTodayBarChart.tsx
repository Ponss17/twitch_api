...
export function AnalyticsTodayBarChart({
    ...
    return (
        <div className="col-span-1 lg:col-span-2 flex flex-col rounded-xl border border-white/[0.08] bg-bg-card p-6 transition-colors duration-200 hover:border-primary/50 h-[420px]">
                ...
                >
                    <ResponsiveContainer width="100%" height="100%" minWidth={0}>
                        <ComposedChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }} accessibilityLayer={false}>
                            ...
                            <Bar dataKey="Éxitos" fill={COLORS[0]} stroke={COLORS[0]} shape={<CustomBarShape />} maxBarSize={48} />
