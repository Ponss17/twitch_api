                    ...
                    <div className="flex w-full items-center gap-2 sm:w-auto">
                        <Dropdown className="relative w-full sm:w-auto">
                            ...
                            >
                                ...
                                <div className="max-h-[240px] overflow-y-auto overscroll-contain px-1 py-1 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-border-strong [&::-webkit-scrollbar]:w-1.5">
                        ...
                        {selectedTz !== currentTimezone && (
                            <button
                                disabled={saving}
                                onClick={() => void handleSave()}
                                className={`${btnSecondary} shrink-0 animate-fade-in`}
                            >
