...
export function LandingStage({
    ...
    return (
        <section id={id} className={`relative scroll-mt-24 px-5 pt-16 pb-20 md:px-8 md:pt-24 md:pb-28 ${className}`}>
            ...
            <div className="relative z-[1] mx-auto max-w-[1120px] rounded-[1.75rem] border border-white/[0.07] bg-bg-secondary px-5 py-10 md:rounded-[2.25rem] md:px-10 md:py-14">
                <div
