...
export const StalkerModule = {
    ...
    async inspectUser(login) {
        try {
            ...
            if (cachedInfo) {
                import('../../../shared/utils/profileModal.js').then(({ ProfileModal }) => ProfileModal.open(cachedInfo));
                return;
            }
            ...
            import('../../../shared/utils/profileModal.js').then(({ ProfileModal }) => ProfileModal.open(info));
        }
        catch (_e) {
